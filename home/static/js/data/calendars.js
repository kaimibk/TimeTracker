    ...
    $(function() {
        $.ajax({
            ...
            success: function (data) {
                console.log("(Success) Get Calendars")
                // var _temp = [];
                $.each(data["response"], function(i, cc) {
                    var calendar = new CalendarInfo();
                    calendar.id = cc.id;
                    calendar.name = cc.name;
                    // calendar.color = cc.color;
                    calendar.bgColor = cc.color;
                    calendar.dragBgColor = cc.color;
                    // calendar.borderColor = cc.borderColor;
                    // _temp.push(calendar);
                    addCalendar(calendar);
                });
                // console.log(CalendarList);
                // CalendarList.push(_temp);
