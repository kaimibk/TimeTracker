...
function generateSchedule(viewName, renderStart, renderEnd) {
    ...
    $(function() {
        $.ajax({
            ...
            async: false,
            data: {
                renderStart: JSON.stringify(renderStart),
                renderEnd: JSON.stringify(renderEnd),
            },
            success: function (data) {
                ...
                $.each(data["response"], function(i, event) {
                    ...
                    var calendar = findCalendar(event.calendarId.toString());
                    schedule.calendarId = calendar.id;
                    ...
                    schedule.category = event.category
